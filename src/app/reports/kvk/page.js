      ...
      {isLoading ? (
        ...
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-[#13161c] border border-[#1e222b] border-t-4 border-t-emerald-500 rounded-xl p-6 shadow-xl flex flex-col items-center justify-center text-center relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/5 rounded-full blur-[30px] -mr-10 -mt-10"></div>
                         ...
                         {report.topAlliances.map((tagObj, i) => (
                             <div key={i} className="flex items-center justify-between p-4 hover:bg-white/5 rounded-lg transition-colors border-b border-[#1e222b]/50 last:border-0">
                                 ...
                                 <div className="text-right">
                                     <div className="text-emerald-400 font-mono font-bold text-xl">{formatBillion(tagObj.kpGained)} KP</div>
                ...
                {/* Top 10 Individual Warriors */}
                 <div className="bg-[#0f1115] border border-[#1e222b] rounded-xl shadow-xl overflow-hidden flex flex-col">
                     <div className="bg-[#0a0c0f] px-6 py-5 border-b border-[#1e222b] flex items-center justify-between gap-3">
                         ...
                         <span className="text-[9px] bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2 py-0.5 rounded font-bold uppercase tracking-widest">
                         ...
                         {report.topWarriors.map((gov, i) => (
                             <div key={i} className="flex items-center justify-between p-3.5 hover:bg-white/5 rounded-lg transition-colors border-b border-[#1e222b]/50 last:border-0 group">
                                 <div className="flex items-center gap-3">
                                     ...
                                     <div>
                                         <h3 className="text-white font-bold text-sm tracking-wider uppercase group-hover:text-emerald-400 transition-colors">{gov.name}</h3>
                                 ...
                                 <div className="text-right flex items-center gap-4">
                                     <div className="hidden sm:block">
                                        ...
                                        <div className="text-emerald-400 font-mono font-bold text-sm">+{formatMillion(gov.kpGained)}</div>
                                     </div>
                                     <div className="text-right">
