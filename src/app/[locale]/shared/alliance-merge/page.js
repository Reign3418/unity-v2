                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
                                {targets.map(target => {
                                     ...
                                     return (
                                         <div 
                                             key={target.id}
                                             className={`bg-[#0f1115] border ${isFull ? 'border-red-500/50 shadow-[0_0_20px_rgba(239,68,68,0.1)]' : 'border-[#2d323e]'} rounded-xl flex flex-col relative overflow-hidden h-[450px] shadow-lg`}
                                         >
                                              {/* Header */}
