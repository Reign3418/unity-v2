      ...
      <div className="animate-fade-in w-full mx-auto mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">{t('raw_spreadsheets')}</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">{t('cloud_db')}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              {t('cloud_desc')}
            </p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-400 mb-2">{t('ai_scanner')}</h3>
