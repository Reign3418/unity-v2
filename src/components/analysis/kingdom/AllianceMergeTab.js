                            ...
                            {targets.map(target => {
                                 ...
                                 return (
                                     <div 
                                         ...
                                         className={`bg-[#0f1115] border ${isFull ? 'border-red-500/50 shadow-[0_0_20px_rgba(239,68,68,0.1)]' : 'border-[#2d323e] hover:border-indigo-500/50'} rounded-xl flex flex-col relative overflow-hidden group transition-colors h-[calc(85vh-200px)] shadow-lg`}
                                     >
                                          {/* Header */}
